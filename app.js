...
const CONTENT = {
  ...
  faq: {
    ...
    items: [
      { q: "למי השירות מתאים?", a: "למבוגרים ולבני נוער (13+) שמתמודדים עם חרדה, עומס, דחיינות, דימוי עצמי נמוך או תקיעות רגשית — ורוצים כלים מעשיים לחוסן וביטחון. יש מסלולים נפרדים למבוגרים ולנוער." },
