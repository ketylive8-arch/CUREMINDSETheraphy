...
const CONTENT = {
  ...
  hero: {
    ...
    stats: ["+500 תהליכים אישיים", "הכשרות NLP בינלאומיות", "לכל בני הנוער · לכל ההורים · למבוגרים"],
    ...
    items: [
      {
        ...
        price: "₪297",
        priceNote: "לחודש · ₪1,990 לשנה (חיסכון 44%)",
        trial: "לאחר 3 ימי ניסיון בחינם",
        highlight: false,
        features: [
          "מלווה רגשי חכם בשיטת CureMindset — זמין 24/7, מכיר אותך ואת הדפוסים שלך",
          "מסע יומי מודרך — שיעור, תרגול והרגעה בכל יום, שנפתח בקצב שלך",
          "צ'ק-אין רגשי יומי עם מענה אישי — שיקוף, כלים ומשימות מותאמות",
          "ציון חוסן אישי ומעקב התקדמות — רואים את השינוי לאורך זמן",
          "ספריית תרגילים, אודיו מודרך וכל חומרי השיטה — גישה מלאה",
          "עוגן SOS לרגעים קשים — תרגול הרגעה מיידי בכל רגע",
        ],
      ...
      },
      {
        ...
        price: "₪1,980",
        priceNote: "חבילת 6 מפגשים · ₪330 למפגש",
        trial: "או מפגש בודד ₪350",
        highlight: true,
        features: [
          ...
          "חיסכון של ₪120 בחבילה מול מפגשים בודדים",
      ...
      <div className="max-w-[1180px] mx-auto px-5 sm:px-7 grid grid-cols-1 lg:grid-cols-[1.05fr_.95fr] gap-10 lg:gap-16 items-center">
        <div className="text-center lg:text-start order-2 lg:order-1">
          ...
          <div className="flex flex-wrap gap-4 justify-center lg:justify-start mb-7">
            ...
            <Button as="a" href="#organizations" variant="outline" size="lg" icon="arrow-left" iconPos="end" aria-label="מעבר לסדנאות לארגונים ומכינות">
              סדנאות לארגונים ומכינות
            </Button>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[.85fr_1.15fr] gap-10 lg:gap-16 items-center mb-14">
          ...
          <Reveal className="text-center lg:text-start">
            ...
            <p className="text-ink-500 text-[18px] leading-[1.6] mb-5">
              ...
              ועקרונות הגמישות המוחית (Neuroplasticity). אני מלווה כל הורה וכל בן ובת נוער — וגם מבוגרים — בדרך מחרדה, עומס
...
function PlanCard({ plan, idx, onEnterApp }) {
  ...
  // התוכנית הדיגיטלית = כניסה למסע: הרשמה → 3 ימי התנסות → ורק אז תשלום (לא ישר ל-Grow).
  const isDigital = plan.id === "digital";
  return (
    <Reveal
    ...
    >
      ...
      {isDigital ? (
        <button
          type="button"
          onClick={onEnterApp}
          className="w-full py-4 rounded-full text-center font-heading font-semibold text-[17px] transition-all duration-300 hover:-translate-y-0.5 bg-gold-500 text-white hover:bg-gold-400 shadow-[0_8px_24px_-8px_rgba(194,151,74,0.6)]"
        >
          {plan.cta} · 3 ימי התנסות חינם
        </button>
      ) : (
      <a
        href={ctaHref}
      ...
      {isDigital && (
        <p className="text-center text-[12px] mt-2 text-ink-400">
          ללא כרטיס אשראי · מתחילים מיד · תשלום רק אחרי ההתנסות
        </p>
      )}
      {payLink && !isDigital && (
  ...
  return (
    <section id="plans" className="py-16 sm:py-24" style={{ background: "linear-gradient(180deg, #FAFAF8 0%, #FFF8F0 100%)" }}>
      <div className="max-w-[1180px] mx-auto px-5 sm:px-7">
        ...
        {/* למי זה מתאים — פילוח מהיר: לעצמי/לילדי מול לארגון */}
        <Reveal className="max-w-[720px] mx-auto mb-11">
          <p className="text-center text-ink-500 text-[15px] mb-4">למי מיועד הליווי?</p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="#plans-cards" className="flex-1 sm:max-w-[280px] inline-flex items-center justify-center gap-2 rounded-full bg-gold-500 text-white font-heading font-bold text-[15px] py-3.5 px-6 transition-all hover:bg-gold-600 hover:-translate-y-0.5">
              <Icon name="heart" size={17} />
              לעצמי / לילד או לילדה שלי
            </a>
            <a href="#organizations" className="flex-1 sm:max-w-[280px] inline-flex items-center justify-center gap-2 rounded-full border border-gold-300 bg-gold-50 text-gold-700 font-heading font-bold text-[15px] py-3.5 px-6 transition-all hover:bg-gold-100 hover:-translate-y-0.5">
        ...
        <div id="plans-cards" className="grid grid-cols-1 md:grid-cols-2 gap-7 items-start">
...
/* ---------------------------------------------------------------- */
/* Organizations — סדנאות והרצאות לארגונים, הייטק ומכינות              */
/* ---------------------------------------------------------------- */

const ORG_CALENDLY = "https://calendly.com/ketysegev";

const ORG_PROGRAMS = [
  { icon: "mic", tag: "הרצאה", title: "הרצאת פתיחה · 90 דקות", text: "הרצאה חווייתית שמניעה את הצוות — איך המוח מייצר לחץ וחרדה, ומה אפשר לעשות אחרת כבר למחרת בבוקר. מתאימה לכינוס, יום גיבוש או פתיחת שנה.", points: ["הבנה עמוקה של מנגנון הלחץ", "כלים מיידיים לוויסות רגשי", "שפה משותפת לצוות שלם"], featured: false },
  { icon: "users", tag: "סדנה", title: "סדנת חוסן · 3 מפגשים", text: "תהליך קבוצתי חווייתי שבונה חוסן רגשי צעד־אחר־צעד. משלב תרגול, אינטראקציה וכלים פרקטיים שנשארים עם המשתתפים הרבה אחרי המפגש האחרון.", points: ["התמודדות עם עומס ושחיקה", "תקשורת ונוכחות תחת לחץ", "ארגז כלים אישי לכל משתתף"], featured: true },
  { icon: "sparkles", tag: "תוכנית עומק", title: "תוכנית עומק · 6 מפגשים", text: "ליווי מתמשך לצוותים ולמובילי דרך — תהליך שמחזק מנהיגות רגשית, מפחית שחיקה ובונה תרבות של חוסן שמחזיקה לאורך זמן.", points: ["מנהיגות רגשית ויציבות", "מניעת שחיקה לאורך זמן", "מדידה וליווי אישי בין המפגשים"], featured: false },
];

const ORG_TESTIMONIALS = [
  { initials: "מ׳", who: "מ׳, בת 34, חיפה", text: "הגעתי אחרי שנים של חרדה שליוותה אותי לכל מקום. קטי לא ניסתה 'לתקן' אותי — היא נתנה לי כלים להבין את עצמי. היום אני מתמודדת אחרת לגמרי, בשקט שלא הכרתי." },
  { initials: "א׳", who: "א׳, אם לנער מהקריות", text: "הבן שלי היה סגור וכועס, וכל דלת שניסינו נסגרה. אחרי הליווי הוא התחיל לדבר, להאמין בעצמו ולהרים את הראש. ראיתי אותו חוזר לחיים." },
  { initials: "ד׳", who: "ד׳, מנהלת מחלקה בהייטק", text: "הבאתי את קטי לצוות שלי אחרי תקופה של שחיקה ולחץ. הסדנה נתנה לכולנו שפה משותפת וכלים אמיתיים — האווירה בצוות השתנתה מהיסוד." },
];

const ORG_AUDIENCES = [
  { icon: "sliders-horizontal", title: "חברות הייטק", text: "צוותים תחת עומס, דדליינים ושחיקה — לומדים לנהל את הלחץ במקום שהלחץ ינהל אותם, ולשמור על ראש צלול ויצירתי." },
  { icon: "shield-check", title: "מכינות קדם-צבאיות", text: "בני ובנות נוער לפני צומת משמעותי בחיים — מקבלים כלים אמיתיים לחוסן, לביטחון עצמי ולהתמודדות עם אי-ודאות." },
  { icon: "heart-handshake", title: "ארגונים ועמותות", text: "מסגרות שרוצות לחזק את הרוח הפנימית של הצוות — יום עיון, סדנה מתמשכת או תהליך עומק, מותאם למטרות שלכם." },
];

function OrgProgramCard({ program, idx }) {
  return (
    <Reveal
      style={{ transitionDelay: `${idx * 80}ms` }}
      className={`relative flex flex-col gap-4 rounded-2xl bg-white p-8 transition-all duration-300 hover:-translate-y-1.5 ${
        program.featured
          ? "border-2 border-gold-400 shadow-[0_28px_60px_-24px_rgba(194,151,74,0.5)]"
          : "border border-ink-100 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] hover:shadow-[0_28px_60px_-24px_rgba(194,151,74,0.4)]"
      }`}
    >
      {program.featured && (
        <span className="absolute -top-3 inset-inline-start-8 px-3.5 py-1 rounded-full bg-gold-500 text-white font-heading font-bold text-[12px] tracking-wide shadow-soft">
          הכי מבוקש
        </span>
      )}
      <div className="flex items-center gap-3">
        <span className="inline-flex items-center justify-center w-[52px] h-[52px] rounded-xl bg-gold-50 border border-gold-200 text-gold-600">
          <Icon name={program.icon} size={24} />
        </span>
        <span className="font-heading font-semibold text-[13px] tracking-[0.16em] text-gold-600">{program.tag}</span>
      </div>
      <h3 className="font-heading font-bold text-[23px] leading-tight text-ink-800">{program.title}</h3>
      <p className="text-[16px] leading-[1.65] text-ink-500 flex-1">{program.text}</p>
      <ul className="flex flex-col gap-2.5 mt-1">
        {program.points.map((p) => (
          <li key={p} className="flex items-start gap-2.5 text-ink-700 text-[15px] leading-snug">
            <Icon name="check-circle-2" size={18} className="text-gold-600 shrink-0 mt-0.5" />
            {p}
          </li>
        ))}
      </ul>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className={`mt-3 inline-flex items-center justify-center gap-2 rounded-full font-heading font-bold text-[15px] py-3.5 transition-all hover:-translate-y-0.5 ${
          program.featured ? "bg-gold-500 text-white hover:bg-gold-600" : "border border-gold-300 bg-gold-50 text-gold-700 hover:bg-gold-100"
        }`}
      >
        <Icon name="calendar" size={17} />
        לתיאום שיחה והתאמה אישית
      </a>
    </Reveal>
  );
}
...
function Organizations() {
  ...
  return (
    <section id="organizations" className="py-16 sm:py-24 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #1c1a17 0%, #2a2621 100%)" }}>
      <div className="absolute inset-0 pointer-events-none" style={{ background: "radial-gradient(46% 40% at 82% 12%, rgba(194,151,74,.22), transparent 70%), radial-gradient(40% 40% at 12% 88%, rgba(190,114,64,.14), transparent 72%)" }} aria-hidden="true" />
      <div className="max-w-[1180px] mx-auto px-5 sm:px-7 relative">
        <Reveal className="text-center max-w-[780px] mx-auto mb-14">
          <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-gold-400/40 text-gold-300 font-heading text-[13px] font-semibold tracking-[0.16em] mb-6">
            <Icon name="users" size={15} />
            לארגונים
          </span>
          <h2 className="font-heading font-extrabold text-white text-[28px] sm:text-[40px] leading-tight mb-5">
            חוסן רגשי לצוות שלכם
            <span className="block text-gold-300 text-[19px] sm:text-[23px] font-bold mt-3">סדנאות והרצאות לארגונים, חברות הייטק ומכינות קדם-צבאיות</span>
          </h2>
          <p className="text-white/70 text-[17px] sm:text-[18px] leading-[1.7]">
            צוות רגוע, ממוקד ובעל חוסן פנימי הוא הנכס הכי חשוב שיש. אני מביאה לארגון שלכם כלים מעשיים לוויסות רגשי, להתמודדות עם לחץ ולבניית תרבות של יציבות — בשפה שמדברת גם לגברים וגם לנשים, בכל שלב בחיים.
          </p>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-7 items-stretch mb-16">
          {ORG_PROGRAMS.map((p, i) => (
            <OrgProgramCard key={p.title} program={p} idx={i} />
          ))}
        </div>
        <Reveal className="text-center mb-10">
          <h3 className="font-heading font-bold text-white text-[22px] sm:text-[26px]">למי זה מתאים?</h3>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {ORG_AUDIENCES.map((a, i) => (
            <Reveal key={a.title} style={{ transitionDelay: `${i * 80}ms` }} className="rounded-2xl bg-white/[0.06] border border-white/10 p-7 text-center backdrop-blur-sm">
              <span className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-gold-500/15 border border-gold-400/30 text-gold-300 mb-4">
                <Icon name={a.icon} size={26} />
              </span>
              <h4 className="font-heading font-bold text-[19px] text-white mb-2">{a.title}</h4>
              <p className="text-white/65 text-[15px] leading-[1.6]">{a.text}</p>
            </Reveal>
          ))}
        </div>
        <Reveal className="max-w-[720px] mx-auto rounded-2xl bg-gradient-to-br from-gold-500 to-gold-600 px-7 py-9 text-center shadow-[0_28px_60px_-24px_rgba(194,151,74,0.7)]">
          <h3 className="font-heading font-extrabold text-white text-[22px] sm:text-[27px] mb-3">רוצים להביא את זה לארגון שלכם?</h3>
          <p className="text-white/90 text-[16px] leading-[1.65] mb-6">נקבע שיחת היכרות קצרה, אבין מה הצוות שלכם צריך, ואבנה יחד איתכם הצעה מדויקת — הרצאה, סדנה או תהליך עומק.</p>
          <a href={ORG_CALENDLY} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-full bg-white text-gold-700 font-heading font-bold text-[16px] px-8 py-4 transition-all hover:-translate-y-0.5 hover:shadow-lg">
            <Icon name="calendar" size={19} />
            לקביעת שיחת היכרות ביומן
          </a>
        </Reveal>
      </div>
    </section>
    ...
    <section id="results" className="py-20 sm:py-28 relative overflow-hidden" style={{ background: "linear-gradient(180deg, #FDFBF7 0%, #FFF8F0 100%)" }}>
      ...
      <div className="max-w-[1180px] mx-auto px-5 sm:px-7 relative">
        ...
        <Reveal className="text-center max-w-[720px] mx-auto mb-8">
          <h3 className="font-heading font-bold text-ink-800 text-[22px] sm:text-[26px]">מה מספרים מי שכבר עברו את התהליך</h3>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          {ORG_TESTIMONIALS.map((t, i) => (
            <Reveal key={t.who} style={{ transitionDelay: `${i * 80}ms` }} className="rounded-2xl bg-white border border-ink-100 p-7 flex flex-col gap-4 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)]">
              <Icon name="quote" size={26} className="text-gold-400" />
              <p className="text-ink-700 text-[16px] leading-[1.7] flex-1">“{t.text}”</p>
              <div className="flex items-center gap-3 pt-1">
                <span className="flex-none w-11 h-11 rounded-full bg-gradient-to-br from-gold-400 to-gold-600 text-white font-heading font-bold text-[16px] flex items-center justify-center">{t.initials}</span>
                <span className="font-heading font-semibold text-[14.5px] text-ink-600">{t.who}</span>
              </div>
            </Reveal>
          ))}
        </div>
