...
const CONTENT = {
  ...
  workshops: {
    ...
    items: [
      ...
      { icon: "graduation-cap", title: "חוסן ודימוי עצמי לנוער", meta: "3 מפגשים · עד 8 תלמידים · כיתות ז׳–י״ב · בתי ספר", text: "מפגש 1 — חוסן וויסות רגשי והתמודדות עם לחץ חברתי; מפגש 2 — דימוי עצמי, ביטחון ופירוק דחיינות; מפגש 3 — כלים לחיים ו-Future Pacing מותאם נוער. יוצאים עם ערכת כלים מעשית." },
