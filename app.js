...
const CONTENT = {
  ...
  hero: {
    ...
    headline: "המוח שלך יודע לרפא. השיטה הזאת מראה לו איך.",
    subhead: "חרדה, לחץ, דחיינות, דימוי עצמי נמוך — אלה לא כישלונות. אלה הגנות ישנות שהפסיקו לשרת אותך.",
    ctaPrimary: "להתחיל — 3 ימים בחינם",
    ctaNote: "בלי כרטיס אשראי · מתחילים עכשיו",
  ...
  method: {
    eyebrow: "השיטה",
    title: "ריפוי שמתחיל בהקשבה, לא בלחימה",
    items: [
      { icon: "eye", title: "Clarity · בהירות", text: "פוגשים את שומר הראש: מזהים את הדפוס ואת התפקיד שהוא בא למלא." },
      { icon: "wind", title: "Unblock · שחרור חסמים", text: "משחררים את העומס שהצטבר שנים במערכת העצבים." },
      { icon: "refresh-cw", title: "Rewire · חיווט מחדש", text: "כותבים מחדש את פרוטוקול הביטחון של המוח." },
      { icon: "trending-up", title: "Empower · העצמה", text: "חוסן שמחזיק — ומערכת הפעלה פנימית לחיים." },
    ],
    ...
    items: [
      ...
      },
      {
        ...
        features: [
          ...
          "1:1 — פרונטלי או בזום",
          "עבודה ממוקדת חוסן, ביטחון וויסות רגשי",
  ...
  faq: {
    ...
    items: [
      { q: "למי השירות מתאים?", a: "למבוגרים ולבני נוער (13+) שמתמודדים עם חרדה, עומס, דחיינות, דימוי עצמי נמוך או עמידה במקום — ורוצים כלים מעשיים לחוסן וביטחון. יש מסלולים נפרדים למבוגרים ולנוער." },
      ...
      { q: "אני הורה — איך זה עובד עם בן/בת נוער?", a: "לנוער יש מסלול ייעודי (CURE Teens) — ליווי רגשי אישי לחיזוק חוסן וביטחון של המתבגר/ת. מתחילים בשיחת אבחון קצרה ללא עלות, שבה נתאים יחד את המסלול והקצב." },
      ...
      <div className="max-w-[1080px] mx-auto px-5 sm:px-7 relative">
        ...
        <Reveal className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-12 max-w-[820px] mx-auto">
          {[
            ...
            { icon: "sparkles", label: "כלים לחוסן", sub: "תרגול שממשיך בין המפגשים" },
          ].map((f, i) => (
...
function HbRecognize() {
  const items = [
    ...
    "תחושה שהחיים זזים, ואתם עומדים במקום.",
  ];
  return (
...
const HB_FAQ = [
  { q: "למי התהליך מתאים?", a: "לכל מי שחווה חרדה, לחץ, עמידה במקום או ביקורת עצמית חוזרת — מתבגרים, הורים ומבוגרים." },
  { q: "איך אני יודע/ת שבאמת מבינים מה עובר על הילד/ה שלי?", a: "התהליך מתחיל תמיד בהקשבה, לא באבחנה קבועה מראש. בשיחת ההיכרות ובמפגש הראשון ממפים יחד עם המשפחה מה באמת קורה — לפי הדפוס הספציפי של הילד/ה שלכם, לא לפי תבנית אחידה." },
  { q: "כמה מפגשים זה ייקח, ואיך יודעים שזה מתקדם?", a: "התהליך בנוי, לא פתוח-לנצח: תוכנית הפרימיום כוללת לפחות שישה מפגשים עם מדידה בפתיחה, באמצע ובסיום — כדי שרואים בבירור מה השתנה, לא רק מרגישים את זה." },
  { q: "מה אם המתבגר/ת שלי מפחד/ת או מתנגד/ת להגיע?", a: "זה נורמלי לגמרי, ורוב המשפחות מגיעות עם בדיוק החשש הזה. המפגש הראשון בנוי להיות קליל ובגובה העיניים, לא חקירה — ורוב בני הנוער שמגיעים סקפטיים חוזרים ממנו עם נכונות להמשיך." },
  ...
  { q: "זה עוזר גם לתקשורת בינינו כהורים לילד/ה, או רק לו/ה?", a: "שניהם. כשמתבגר/ת לומד/ת לזהות ולהביע מה עובר עליו/ה, זה כמעט תמיד משפר גם את השיח בבית — פחות התפרצויות או ניתוק, יותר שיחה אמיתית." },
  { q: "יש למי לפנות גם מחוץ לשעות המפגש?", a: "כן. מעבר למפגשים עם קטי, יש ליווי דיגיטלי זמין תמיד — לתרגול, לשאלה או לרגע קשה שלא יכול לחכות לפגישה הבאה." },
