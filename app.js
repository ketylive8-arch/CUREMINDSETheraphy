  ...
  return (
    ...
    >
      <div className="relative rounded-2xl bg-white border border-gold-200 shadow-[0_26px_64px_-26px_rgba(120,90,30,0.55)] p-5 pe-10">
        ...
        <a href={BOOKING_LINKS.calendar || waLink("היי קטי! אשמח להתחיל ניסיון חינם")} target="_blank" rel="noopener noreferrer"
          ...
          <Icon name="calendar" size={17} /> להתחיל ניסיון חינם
        </a>
      </div>
    </div>
  );
