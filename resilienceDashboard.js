    ...
    return (
      <section className="mb-6">
        ...
        {wins.length ? (
          ...
          <EmptyState
            text="אין עדיין הצלחות מתועדות — כל שיחה ותרגול שתעשי יופיעו כאן כניצחון שלך."
            actionLabel="להתחלת שיחה עם המלווה"
            onAction={() => onNavigateStage(5)}
          />
        )}
      </section>
    );
    ...
    return (
      <section className="mb-6">
        ...
        {patterns.length ? (
          ...
          <EmptyState
            text="בקרוב נשקף כאן דפוסי חשיבה שעולים מהשיחות שלך — ככל שתשתפי יותר, השיקוף יתעדכן."
            actionLabel="להמשך שיחה עם המלווה"
            onAction={() => onNavigateStage(5)}
          />
        )}
      </section>
